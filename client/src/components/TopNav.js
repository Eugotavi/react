    ...
    const TopNav = () => {
        ...
        <div className='max-w-[1520px] mx-auto flex justify-between items-center p-4'>
                <div className='flex items-center'>
                    ...
                    <h1 className='text-2px sm:text-3xl lg:text-4xl px-2'> Galeria
                    <span> da</span><span className='text-orange-700 font-bold'> Fafa</span>
                    </h1>
            ...
            <button className='bg-orange-700 text-white hidden md:flex items-center py-2 rounded-full'>
             ...
             className={
                ...
                />
                <h2 className='text-2xl p-4'>Galeria<span className='text-2xl p-1'>da</span>
                <span className='text-orange-700 font-bold'>Fafa</span></h2>
                 <nav>
